...
def getAllChEMBLPredictions():
    ...
    """
    cd /hps/nobackup/production/uniprot/rahmet/DEEPScreen/LOGS/LoadModels
    bsub -q research-rh74 -M 1024 "cat testDrugs_*batch* | grep "^ACTPRED" > ../../resultFiles/all_chembl_predictions_over.txt"

    cd /hps/nobackup/uniprot/tdogan/Ahmet/DEEPScreen/LOGS/LoadModels
    bsub -q research -M 1024 "cat testDrugs_*batch* | grep "^ACTPRED" > ../../resultFiles/all_chembl_predictions_over.txt"
    """