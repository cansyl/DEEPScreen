...
for line in lst_best_fl[1:]:
    ...
    print("bsub -q research -R 'select[nprocs<=2]' -M 10240 -R 'rusage[mem=10240]'  -o ../LOGS/LoadModels/loadModel_{}.out \"python loadModel.py {} drugs_case_study.txt\"".format(target, target))
    print("sleep 5")
